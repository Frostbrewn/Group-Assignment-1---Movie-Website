...
<div class="row">
	...
	<label for="" class="control-label">Choose Seat Group</label>
		<select name="seat_group" id="seat_group" class="custom-select default-browser" required="" action="reserveContinue.php" method="post">
			<option value="">
...
<div class="row">
	<div class="form-group col-md-2">
		...
		<input type="number" name="qty" id="qty" class="form-control" min="0" required="" action="cinema_box.php" method="post">
	</div>
	<div class="form-group col-md-4">
		<label for="" class="control-label">Date</label>
		<select name="date" id="date" class="custom-select browser-default" action="cinema_box.php" method="post">
			<?php 
	...
	<div class="form-group col-md-4">
		...
		<select name="time" id="time" class="custom-select browser-default" action="cinema_box.php" method="post">
			<?php 
			$i = 1;
